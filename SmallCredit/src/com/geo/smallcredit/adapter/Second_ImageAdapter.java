...
public class Second_ImageAdapter extends BaseAdapter {

	private Context mContext;
	private LayoutInflater mInflater;
	private static final int[] ids = { R.drawable.senond_main_lunbo, };

	public Second_ImageAdapter(Context context) {
		mContext = context;
