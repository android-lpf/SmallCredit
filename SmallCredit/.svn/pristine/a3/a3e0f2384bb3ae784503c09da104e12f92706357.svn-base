package com.geo.smallcredit.listviewgroup.view;
...
import com.geo.smallcredit.activity.MeansUploadActivity;
import com.geo.smallcredit.adapter.AdapterWrapper;
import com.geo.smallcredit.adapter.MailAdapter;
import com.geo.smallcredit.adapter.StickyListHeadersAdapter;
...
public class MailListView extends ListView {
	...
	private void init(Context paramContext) {
		...
		((MeansUploadActivity) paramContext).getWindowManager().getDefaultDisplay().getMetrics(localDisplayMetrics);
